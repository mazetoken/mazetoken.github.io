...
- Windows: download and unzip the miner, paste your WIF (wallet private key) in .env file and copy this file to fastmine folder, open PowerShell and type `npm i` and `npm start`
...
_MAZE TOKEN 2020, created by [B_S_Z](https://t.me/b_s_z)
